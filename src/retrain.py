...
def retrain(exp_path: str):
    ...
    retrain_path = os.path.join(exp_path, 'retrain')
    log_path = os.path.join(retrain_path, exp_name)
...
if __name__ == "__main__":
    retrain("./experiments/20250417_164542_ppo_1layer_TrackingTask")