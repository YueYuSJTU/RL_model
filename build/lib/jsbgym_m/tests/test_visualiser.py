import time
import unittest
from jsbgym_m.environment import JsbSimEnv
from jsbgym_m.visualiser import FigureVisualiser, FlightGearVisualiser
from jsbgym_m.tests.stubs import BasicFlightTask, DefaultSimStub
import matplotlib.pyplot as plt
import jsbgym_m.visualiser
...
class TestFigureVisualiser(unittest.TestCase):
    ...
    def test_plot_creates_figure_and_axes(self):
        ...
        self.assertIsInstance(self.visualiser.axes, jsbgym_m.visualiser.AxesTuple)
