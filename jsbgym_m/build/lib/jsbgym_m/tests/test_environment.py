...
import jsbgym_m
from jsbgym_m import aircraft, tasks, utils
from jsbgym_m.environment import JsbSimEnv, NoFGJsbSimEnv
from jsbgym_m.tests.stubs import BasicFlightTask
from jsbgym_m.visualiser import FlightGearVisualiser
...
class TestGymRegistration(unittest.TestCase):
    ...
    def test_gym_environment_makeable_by_gym_from_enum(self):
        for jsb_env_id in jsbgym_m.Envs:
